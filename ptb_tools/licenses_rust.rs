...
pub fn get_licenses() -> Vec<LicenseInfo> {
  return vec![
    ...
    LicenseInfo {
        ...
        version: "0.4.1",
        license: "MIT OR Apache-2.0",
        authors: vec!["Steven Fackler <sfackler@gmail.com>", "Robert Bragg <robert@sixbynine.org>"] 
    },
    LicenseInfo {
        name: "jni-sys-macros",
        version: "0.4.1",
        license: "MIT OR Apache-2.0",
        authors: vec!["Robert Bragg <robert@sixbynine.org>"] 
    },
    LicenseInfo {
        name: "jobserver",
        version: "0.1.34",
    ...
    LicenseInfo {
        ...
        version: "1.1.1",
        license: "Apache-2.0 OR MIT",
        authors: vec!["Sean C. Roach <me@seancroach.dev>"] 
    },
    LicenseInfo {
        name: "simd_helpers",
        version: "0.1.0",
    ...
    LicenseInfo {
        ...
        version: "0.1.5",
        license: "MIT OR Apache-2.0",
        authors: vec!["Hans Kratz <hans@appfour.com>"] 
    },
    LicenseInfo {
        name: "skrifa",
        version: "0.37.0",
